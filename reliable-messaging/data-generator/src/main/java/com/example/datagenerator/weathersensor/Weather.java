package com.example.datagenerator.weathersensor;
...
public class Weather {
    ...
    public static Weather createWeather(String[] attributes) {
        ...
        float prcp = !attributes[5].isEmpty() ? Float.valueOf(attributes[5]) : 0;
        int snow = !attributes[6].isEmpty() ? Integer.valueOf(attributes[6]) : 0;
        int wdir = !attributes[7].isEmpty() ? Integer.valueOf(attributes[7]) : 0;
        float wspd = !attributes[8].isEmpty() ? Float.valueOf(attributes[8]) : 0;
        float wpgt = !attributes[9].isEmpty() ? Float.valueOf(attributes[9]) : 0;
